...
export default function AdminPage() {
  ...
  const actionIcons: Record<string, { icon: string; color: string }> = {
    PROPERTY_CREATED: { icon: 'token', color: 'text-[#14b8a7]' },
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <Link href="/admin/mint" className="bg-[#14b8a7] text-white px-5 py-2.5 rounded-xl font-semibold flex items-center gap-2 hover:bg-[#14b8a7]/90 transition-colors shadow-lg shadow-[#14b8a7]/20">
        ...
        {[
          ...
          <div key={card.title} className="bg-white rounded-xl p-6 border border-[#14b8a7]/10 shadow-sm hover:border-[#14b8a7]/30 transition-all">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="material-symbols-outlined text-[#14b8a7] bg-[#14b8a7]/10 p-1.5 rounded-lg">{card.icon}</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
        ...
        <div className="lg:col-span-8">
          <div className="bg-white rounded-xl border border-[#14b8a7]/10 overflow-hidden shadow-sm">
            <div className="p-5 border-b border-[#14b8a7]/10 flex items-center justify-between">
              <h3 className="font-bold text-lg">Recent Activity</h3>
              <button className="text-[#14b8a7] text-xs font-bold hover:underline">View All Activity</button>
            </div>
          ...
          <div className="mt-6 bg-slate-900 rounded-xl p-5 text-white overflow-hidden relative border border-slate-800">
            ...
            <div className="relative z-10">
              <h4 className="font-bold mb-1 flex items-center gap-2">
                <span className="material-symbols-outlined text-[#14b8a7] text-[18px]">verified_user</span>
                Security Check
              </h4>
      ...
      {/* On-Chain Status */}
      <div className="bg-white rounded-xl border border-[#14b8a7]/10 p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            <h3 className="font-bold text-lg mb-1 flex items-center gap-2">
              <span className="material-symbols-outlined text-[#14b8a7]">link</span>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-100 text-emerald-600 rounded-lg">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between text-sm mb-1">
            ...
            <span className="text-[#14b8a7] font-bold">{anchoredPercent}%</span>
          </div>
