...
export function objectToProperty(obj: DualObject, template: Template): Property {
  ...
  const propertyData: PropertyData = {
    ...
    squareFeet: (details?.squareFeet as number) || undefined,
    bedrooms: (details?.bedrooms as number) || undefined,
    bathrooms: (details?.bathrooms as number) || undefined,
    yearBuilt: (details?.yearBuilt as number) || undefined,
    propertyType: ((details?.propertyType as string) || 'residential') as 'residential' | 'commercial' | 'industrial' | 'land',
    marketValue: (valuation?.marketValue as number) || undefined,
    taxAssessedValue: (valuation?.taxAssessedValue as number) || undefined,
    ownerName: (owner?.name as string) || '',
    ownerEmail: (owner?.email as string) || undefined,
    ownerPhone: (owner?.phone as string) || undefined,
    features: (details?.features as string[]) || undefined,
